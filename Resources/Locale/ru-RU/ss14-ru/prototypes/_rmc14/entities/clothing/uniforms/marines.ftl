...
ent-CMJumpsuitCargoTech = requisitions technician uniform
    .desc = A standard-issue req tech uniform.
...
ent-CMJumpsuitPilot = pilot bodysuit
    .desc = A bodysuit worn by pilots of the marines, and is meant for survival in inhospitable conditions. Fly the marines onwards to glory. It has shards of light Kevlar to help protect against stabbing weapons and bullets.
