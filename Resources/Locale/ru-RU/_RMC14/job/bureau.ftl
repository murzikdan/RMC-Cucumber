rmc-ghost-role-information-bureau-rules =
    You are a [color=cyan][bold]member of the Colony Marshal Bureau[/bold][/color]. You may or may not be hostile to the marines, depending on admin instructions.
...
rmc-ghost-role-information-bureau-observer-description = Monitor and Document the treatment of interstellar beings within the UNS Ship. Ensure the rights of interstellar beings are being followed, and provide medical treatment where needed.
