rmc-ghost-role-information-hefa-rules =
    You are a [color=yellow][bold]HEFA follower[/bold][/color]. You may or may not be hostile to the marines, depending on admin instructions.
