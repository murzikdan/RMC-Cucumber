...
bounty-description-labeler = Из-за бюрократической ошибки наш сортировочный центр чуть не отправил несколько сотен ящиков моркови в поселение рептилий. Нам срочно нужны дополнительные этикетировщики, чтобы навести порядок на складе.
bounty-description-warm-cloth = Строительная бригада рептилий не может восстановить электропитание на своей станции и замерзает. Нужно прислать им хоть какую-нибудь тёплую одежду.
...
bounty-description-steak = Повар-вегетарианец отказывается готовить нам что-нибудь из мяса, и рептилии начинают беспокоиться. Не могли бы вы тайно доставить нам несколько стейков, чтобы они остались довольны?
