...
ent-RMCPatchFallingFalconsSquad = { ent-RMCPatchFallingFalcons }
    ...
    .desc = { ent-RMCPatchFallingFalcons.desc }
ent-RMCPatchSEA = UNMC Senior Enlisted Advisor patch
    .desc = A fire-resistant shoulder patch, worn by the men and women of the Falling Falcons, the 2nd battalion of the 4th brigade of the UNMC. The bottom reads "THIS WE'LL DEFEND" in silver embroidery.
...
ent-RMCPatchSPPCEC = Exploration Corps patch
    .desc = An old, worn and faded fire-resistant circular patch with a gold star on a split orange and red background. Once worn by members of the Exploration Corps, a division of the SPP dedicated to exploration, resource assessment, and establishing colonies on new worlds. The patch serves as a reminder of the EC's daring missions aboard aging starships, a symbol of perseverance in the face of adversity.
