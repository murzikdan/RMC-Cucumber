...
ent-RMCArmorHelmetPMCTactical = tactical helmet
    .desc = A contender for service with the Royal Crown Marines, it is presently, exclusively, field tested by Weston-Yamada mercenaries. Features a ballistic mask and integrated display connected to the visor.
...
ent-ArmorHelmetPMCFieldOfficer = PMC field officer beret
    .desc = The pinnacle of fashion for any aspiring mercenary leader. Designed to protect the head from light impacts.
ent-ArmorHelmetPMCGunner = PMC specialist operator helmet
    .desc = A modification of the standard PMC tactical helmet, featuring a frontal shield to protect the user's from shrapnel and small arms fire while operating heavy weaponry.
...
ent-ArmorHelmetPMCEngineer = pmc engineer helmet
    .desc = An advanced technician helmet with a black finish, including advanced welding protection and resistance to the potential industrial hazards, but has less kevlar against potential firefights.
