...
ent-CMHeadsetRequisition = requisitions radio headset
    .desc = Used by the Requisitions Technicians, lightweight and portable.
...
ent-CMHeadsetQM = Logistics Officer radio headset
...
ent-RMCHeadsetMW = marine military warden radio headset
    .desc = It seems oddly similar to the CMP's... Smells like donuts too.
