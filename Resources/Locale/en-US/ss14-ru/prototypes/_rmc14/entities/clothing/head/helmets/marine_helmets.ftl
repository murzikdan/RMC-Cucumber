...
ent-RMCArmorHelmetM10FieldDoctor = M10-L field doctor helmet
    .desc = A special variant of the M10 Pattern Helmet worn by the field doctors of the Marines. Comes with a built in medical display HUD.
...
ent-CMArmorHelmetM35 = M35 pyrotechnician helmet
    .desc = A helmet designed for UNMC Pyrotechnicians.
